...
**Pilares de telemetria:**
1. **Métricas** → CPU, latência, requisições, erro rate
2. **Logs** → mensagens estruturadas
3. **Traces (rastreamento distribuído)** → caminho de uma requisição entre serviços

De maneira geral, o OpenTelemetry é o **"idioma universal" da observabilidade**.