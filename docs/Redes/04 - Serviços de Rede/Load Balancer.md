...
O Load Balancer usa diferentes algoritmos para decidir qual servidor receberá a requisição. [Round-robin](Round-robin.md) e [Weighted](Weighted.md) são exemplos de algoritmos utilizados. Em cada um deles há diferentes regras levadas em consideração para passar a requisição ao servidor menos ocupado.  
...
![Pasted image 20251003202154](Imagens/Pasted image 20251003202154.png)