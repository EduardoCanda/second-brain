...
Primeiramente é definido a melhor rota onde os pacotes devem ser entregues. Para isso alguns protocolos nesta camada determinam qual é a "melhor rota".  Nesta camada tudo é tratado com endereços [[IP]]. 
