docs/Web/Browser/Browser Architecture/Event Loop no navegador.md

# Event Loop no navegador

## O que é

Event Loop no navegador descreve uma parte específica do pipeline web entre rede, runtime e renderização.
