docs/Web/Browser/Browser Architecture/Browser Architecture Overview.md

# Browser Architecture Overview

## O que é

Browser Architecture Overview descreve uma parte específica do pipeline web entre rede, runtime e renderização.
