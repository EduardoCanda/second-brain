docs/Web/Browser/Browser Architecture/Browser Rendering Engine.md

# Browser Rendering Engine

## O que é

Browser Rendering Engine descreve uma parte específica do pipeline web entre rede, runtime e renderização.
