docs/Web/Browser/Browser Architecture/Browser Multi Process Architecture.md

# Browser Multi Process Architecture

## O que é

Browser Multi Process Architecture descreve uma parte específica do pipeline web entre rede, runtime e renderização.
