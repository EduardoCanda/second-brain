docs/Web/Browser/Page Loading/O que acontece quando digitamos uma URL no navegador.md

# O que acontece quando digitamos uma URL no navegador

## O que é

O que acontece quando digitamos uma URL no navegador descreve uma parte específica do pipeline web entre rede, runtime e renderização.
