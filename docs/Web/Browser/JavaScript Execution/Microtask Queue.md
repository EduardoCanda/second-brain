docs/Web/Browser/JavaScript Execution/Microtask Queue.md

# Microtask Queue

## O que é

Microtask Queue descreve uma parte específica do pipeline web entre rede, runtime e renderização.
