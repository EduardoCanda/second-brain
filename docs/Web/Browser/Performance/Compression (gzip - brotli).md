docs/Web/Browser/Performance/Compression (gzip - brotli).md

# Compression (gzip / brotli)

## O que é

Compression (gzip / brotli) descreve uma parte específica do pipeline web entre rede, runtime e renderização.
