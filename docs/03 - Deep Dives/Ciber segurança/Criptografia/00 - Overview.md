...
- Quando conectamos em um servidor via [SSH](../../../01 - Fundamentos/Redes/05 - Segurança/SSH.md), uma conexão é estabelecidade de forma encriptada em um "túnel", então ninguém pode espiar a conexão.
