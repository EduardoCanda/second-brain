...
Versão moderna do iperf para testes TCP/UDP. Resolve medição de banda com métricas atuais e JSON opcional.
...
iperf3 vs iperf: iperf3 fornece métricas mais atuais e melhor integração em automação.
