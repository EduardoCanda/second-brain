...
Toolkit criptográfico que inclui cliente TLS e utilitários de certificado. Resolve validação de handshake e cadeia X.509.
...
openssl s_client vs gnutls-cli: use ambos para validar compatibilidade de TLS.
