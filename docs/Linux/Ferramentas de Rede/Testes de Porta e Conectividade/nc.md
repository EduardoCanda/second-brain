...
Netcat tradicional para abrir conexões TCP/UDP e escutar portas. Resolve teste rápido de conectividade de porta.
...
nc vs ncat: ncat traz TLS, proxy e recursos extras de automação.
