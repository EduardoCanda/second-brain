...
Ferramenta moderna para inspeção de sockets e conexões no Linux. Resolve identificação de portas abertas e conexões estabelecidas.
...
ss vs netstat: ss é mais rápido e preciso em kernels modernos.
