...
Sniffer de pacotes em linha de comando com filtros BPF. Resolve investigação de tráfego em tempo real e coleta para análise posterior.
...
tcpdump -i any -nn host 10.0.0.20
