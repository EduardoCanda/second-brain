...
Cliente HTTP com sintaxe amigável e saída legível. Resolve debugging rápido de APIs REST com payload JSON.
...
http POST https://httpbin.org/post name=devops role=sre
