...
CLI do nftables, substituto moderno do iptables. Resolve gerenciamento unificado e escalável de firewall/NAT.
...
nft vs iptables: nft é recomendado para novas implantações.
